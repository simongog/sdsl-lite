...
template<class t_wt>
uint64_t test_interval_symbols(const t_wt& wt, const vector<size_type>& is, const vector<size_type>& js, size_type& k, uint64_t mask, uint64_t times=100000000)
{
...
struct wt_trait<wt_gmr_1<t_bitvector, t_select, t_select_zero>, false> {
    ...
    static uint64_t test_lex_count(const wt_gmr_1<t_bitvector, t_select, t_select_zero>&, const vector<size_type>&, const vector<size_type>&, const vector<value_type>&, uint64_t, uint64_t) {
        return 0;
    }
    static uint64_t test_lex_smaller_count(const wt_gmr_1<t_bitvector, t_select, t_select_zero>&, const vector<size_type>&, const vector<value_type>&, uint64_t, uint64_t) {
        return 0;
    }
};
...
struct wt_trait<wt_gmr_2<t_bitvector, t_select, t_select_zero, t_rank>, false> {
    ...
    static uint64_t test_lex_count(const wt_gmr_2<t_bitvector, t_select, t_select_zero, t_rank>&, const vector<size_type>&, const vector<size_type>&, const vector<value_type>&, uint64_t, uint64_t) {
        return 0;
    }
    static uint64_t test_lex_smaller_count(const wt_gmr_2<t_bitvector, t_select, t_select_zero, t_rank>&, const vector<size_type>&, const vector<value_type>&, uint64_t, uint64_t) {
        return 0;
    }
};
...
struct wt_trait<wt_gmr_3<t_bitvector, t_select, t_select_zero, t_rank>, false> {
    ...
    static uint64_t test_lex_count(const wt_gmr_3<t_bitvector, t_select, t_select_zero, t_rank>&, const vector<size_type>&, const vector<size_type>&, const vector<value_type>&, uint64_t, uint64_t) {
        return 0;
    }
    static uint64_t test_lex_smaller_count(const wt_gmr_3<t_bitvector, t_select, t_select_zero, t_rank>&, const vector<size_type>&, const vector<value_type>&, uint64_t, uint64_t) {
        return 0;
    }
};
...
int main(int argc, char* argv[])
{
    ...
    start = timer::now();
    check = wt_trait<WT_TYPE>::test_interval_symbols(wt,is,js,k,mask,reps_interval_symbols);
    stop = timer::now();
