...
print_info (){
  ...
  echo "# TC_SIZE = 0"
        ...
        DATA_DIR="/home/d056848/Dev/sdsl-lite/benchmark/data/"
	...
	mkdir -p table_3_bfs/uk07-05_2/
        ...
        print_times
        du -c table_3/eu2005/*.il table_3/eu2005/*.lv table_3/eu2005/*.tr | tail -n 1 | awk '{print "# uncompressed_size = "$1}'
        ./compress_leaves "table_3/eu2005/eu2005" 4000000
        echo "Size in kBytes compressed"
        du -c table_3/eu2005/*.cil table_3/eu2005/*.lv table_3/eu2005/*.tr table_3/eu2005/*.voc | tail -n 1 | awk '{print "# compressed_size = "$1}'
        ...
        print_times
        du -c table_3/indo/*.il table_3/indo/*.lv table_3/indo/*.tr | tail -n 1 | awk '{print "# uncompressed_size = "$1}'
        ./compress_leaves "table_3/indo/indo" 4000000
        echo "Size in kBytes compressed"
        du -c table_3/indo/*.cil table_3/indo/*.lv table_3/indo/*.tr table_3/indo/*.voc | tail -n 1 | awk '{print "# compressed_size = "$1}'
        ...
        print_times
        du -c table_3/uk/*.il table_3/uk/*.lv table_3/uk/*.tr | tail -n 1 | awk '{print "# uncompressed_size = "$1}'
        ./compress_leaves "table_3/uk/uk" 4000000
        echo "Size in kBytes compressed"
        du -c table_3/uk/*.cil table_3/uk/*.lv table_3/uk/*.tr table_3/uk/*.voc | tail -n 1 | awk '{print "# compressed_size = "$1}'
        ...
        print_times
        du -c table_3/arab/*.il table_3/arab/*.lv table_3/arab/*.tr | tail -n 1 | awk '{print "# uncompressed_size = "$1}'
        ./compress_leaves "table_3/arab/arab" 4000000
        echo "Size in kBytes compressed"
        du -c table_3/arab/*.cil table_3/arab/*.lv table_3/arab/*.tr table_3/arab/*.voc | tail -n 1 | awk '{print "# compressed_size = "$1}'
        ...
        print_times
        du -c table_3/uk07-05_2/*.il table_3/uk07-05_2/*.lv table_3/uk07-05_2/*.tr | tail -n 1 | awk '{print "# uncompressed_size = "$1}'
        ./compress_leaves "table_3/uk07-05_2/uk07-05" 20000000
        echo "Size in kBytes compressed"
        du -c table_3/uk07-05_2/*.cil table_3/uk07-05_2/*.lv table_3/uk07-05_2/*.tr table_3/uk07-05_2/*.voc | tail -n 1 | awk '{print "# compressed_size = "$1}'
        ...
        print_times
        du -c table_3_bfs/eu2005/*.il table_3_bfs/eu2005/*.lv table_3_bfs/eu2005/*.tr | tail -n 1 | awk '{print "# uncompressed_size = "$1}'
        ./compress_leaves "table_3_bfs/eu2005/eu2005" 4000000
        echo "Size in kBytes compressed"
        du -c table_3_bfs/eu2005/*.cil table_3_bfs/eu2005/*.lv table_3_bfs/eu2005/*.tr table_3_bfs/eu2005/*.voc | tail -n 1 | awk '{print "# compressed_size = "$1}'
        ...
        print_times
        du -c table_3_bfs/indo/*.il table_3_bfs/indo/*.lv table_3_bfs/indo/*.tr | tail -n 1 | awk '{print "# uncompressed_size = "$1}'
        ./compress_leaves "table_3_bfs/indo/indo" 4000000
        echo "Size in kBytes compressed"
        du -c table_3_bfs/indo/*.cil table_3_bfs/indo/*.lv table_3_bfs/indo/*.tr table_3_bfs/indo/*.voc | tail -n 1 | awk '{print "# compressed_size = "$1}'
        ...
        print_times
        du -c table_3_bfs/uk/*.il table_3_bfs/uk/*.lv table_3_bfs/uk/*.tr | tail -n 1 | awk '{print "# uncompressed_size = "$1}'
        ./compress_leaves "table_3_bfs/uk/uk" 4000000
        echo "Size in kBytes compressed"
        du -c table_3_bfs/uk/*.cil table_3_bfs/uk/*.lv table_3_bfs/uk/*.tr table_3_bfs/uk/*.voc | tail -n 1 | awk '{print "# compressed_size = "$1}'
        ...
        print_times
        du -c table_3_bfs/arab/*.il table_3_bfs/arab/*.lv table_3_bfs/arab/*.tr | tail -n 1 | awk '{print "# uncompressed_size = "$1}'
        ./compress_leaves "table_3_bfs/arab/arab" 4000000
        echo "Size in kBytes compressed"
        du -c table_3_bfs/arab/*.cil table_3_bfs/arab/*.lv table_3_bfs/arab/*.tr table_3_bfs/arab/*.voc | tail -n 1 | awk '{print "# compressed_size = "$1}'
        ...
        print_times
        du -c table_3_bfs/uk07-05/*.il table_3_bfs/uk07-05/*.lv table_3_bfs/uk07-05_2/*.tr | tail -n 1 | awk '{print "# uncompressed_size = "$1}'
        ./compress_leaves "table_3_bfs/uk07-05/uk07-05" 20000000
        echo "Size in kBytes compressed"
        du -c table_3_bfs/uk07-05/*.cil table_3_bfs/uk07-05_2/*.lv table_3_bfs/uk07-05_2/*.tr table_3_bfs/uk07-05_2/*.voc | tail -n 1 | awk '{print "# compressed_size = "$1}'
