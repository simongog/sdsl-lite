...
\textit{Public Methods:} \code{operator[$i$]}, \code{size()}\\
...
(e.g. \href{\sdslgitinc/config.hpp.cmake}{\code{constant::KEY\_BWT}}, 
      \href{\sdslgitinc/config.hpp.cmake}{\code{constant::KEY\_SA}},\ldots)
to file paths.\\
...
and inputs $<2$ GiB (see Phase \#2 in the Figure below 
for a $200$ MB text) 
...
\emph{Phases description}: \#1=copy TEXT, \#2=SA, \#3=BWT, \#4=\code{wt\_huff<>},
\#7=LCP, \#8=BP, \#9=\code{bp\_support\_sada<>}, \#10=\code{lcp\_dac<>}.

\input{mm-log-200MB.tex}

This diagram was generated from the output of this
\href{\sdslgit/tutorial/mm-log.cpp}{example program},
which print the memory log to \code{stdout}.
%\section{Performance}
