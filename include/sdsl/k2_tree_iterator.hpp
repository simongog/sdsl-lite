...
namespace sdsl {
    ...
    public:
        ...
        void print() {
            ...
            cout << "   row: " << st.row << endl;
            cout << "   col: " << st.col << endl;
            cout << "   n: " << st.n << endl;
            cout << "   level: " << st.level << endl;
            cout << "   j: " << st.j << endl;
            cout << "   y: " << st.y << endl;
            cout << "   valid: " << st.valid << endl;
            cout << endl;
        }
    ...
    private:
        ...
        _initialize() {
            ...
            if (tree->l().size() > 0) {
                ...
                _ptr = edge(std::get<0>(first), std::get<1>(first));
            } else {
