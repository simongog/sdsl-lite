...
class wt_topk
{
    private:
        ...
        t_wt m_wt;
        result_type m_result; // change this to iterator kind of thing
        t_rmq m_rmq;
        size_t m_size;
            ...
            std::string name="") const
    {
        ...
        written_bytes += write_member(m_size, out, child, "t");
    ...
    // auxiliary functions, may be deleted...
    const int_vector<>
    &get_weights() const {
        return m_weights;
    }
