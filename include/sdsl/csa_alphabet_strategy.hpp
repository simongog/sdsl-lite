	...
	public:
		...
		class char2comp_wrapper{
			...
			public:
				...
				comp_char_type operator[](char_type c) const{ return (comp_char_type) m_strat->m_char_rank( (size_type)c); }
		};
...
class int_alphabet_strategy{
	...
	public:
		 ...
		 */
		template<class size_type_class>
		int_alphabet_strategy(int_vector_file_buffer<0, size_type_class> &text_buf, size_type_class len): 
							           char2comp(this), comp2char(this), C(m_C), sigma(m_sigma)
		{
			m_sigma = 0;
    		text_buf.reset();
