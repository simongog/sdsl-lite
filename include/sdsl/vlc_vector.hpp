...
//    (2) Write z
    util::assign(m_sample_pointer, int_vector<>(samples+1, 0, bits::l1BP(z_size+1)+1));
...
//    (2) Write z
    ...
    util::assign(m_sample_pointer, int_vector<>(samples+1, 0, bits::l1BP(z_size+1)+1));  // add 1 for last entry
