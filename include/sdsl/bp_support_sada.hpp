...
//#define USE_CACHE
    ...
    public:
        ...
        explicit bp_support_sada(const bit_vector* bp): m_bp(bp),
            ...
            m_sml_block_min_max = int_vector<>(2*m_sml_blocks, 0, bits::l1BP(t_sml_blk+2)+1);
            m_med_block_min_max    = int_vector<>(2*(m_med_blocks+m_med_inner_blocks), 0, bits::l1BP(2*m_size+2)+1);
