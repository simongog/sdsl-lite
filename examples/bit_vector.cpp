...
int main(int argc, char* argv[]){
	...
	cout<< "size of b in MB: " << util::get_size_in_mega_bytes(b)<< endl;
	cout<< "size of rb in MB: " << util::get_size_in_mega_bytes(rb)<< endl;
	...
	cout<< "size of rrrb in MB: " << util::get_size_in_mega_bytes(rrrb)<< endl;
	cout<< "size of rank_rrrb in MB: " << util::get_size_in_mega_bytes(rank_rrrb)<< endl;
	...
	util::write_structure<JSON_FORMAT>( rrrb, cout );
	cout<<endl;
